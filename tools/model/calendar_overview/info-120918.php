<?php
        switch($df_ip['ac']):
            case 'list': 
				...
				$cal_list=$this->GM->common_ac('list',array('info'=>$cal_v_set['mm_set'],'type'=>'join_projtask','data'=>array('con_'.$mm_tb.'.jec_user_id'=>$this->ad_id,'wi'=>array($mm_tb.'.noticefrom'=>array(1,2),'jec_projtask.projtasktype'=>array(1,2,5,6)),'con_'.$mm_tb.'.startdate <='=>$search_sed['ed'].' 99:99:99','con_'.$mm_tb.'.enddate >='=>$search_sed['sd'].' 00:00:00')));
				...
				$ip_data=array('con_isactive'=>'Y','pd_pp'=>3,'pd_np'=>0,'gp'=>'Y','ob_created'=>'DESC','con_jec_user_id'=>$this->ad_id,'orwhere'=>array());//

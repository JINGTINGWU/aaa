...
<script type="text/javascript">
    ...
    {        
        if($('#recordtype').val()=='N')
        {            
            location.href='<?=base_url('/ecp_analysis/work_analysis_mng/work_record_index/list/'.$key_id.'/created/DESC/0/-1.html')?>';
        }
        else
        {
            location.href='<?=base_url('/ecp_analysis/work_analysis_mng/work_record_index/list-all/'.$key_id.'/created/DESC/0/-1.html')?>';
        }
    }
</script>
	...
	$df_ip['pp']=$this->m_pp;
        ...
        switch($df_ip['ac']):
            case 'list': 
				...
				//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".count( $final['ip_info']).'-'.count($final['ip_data']);
				//exit();
				...
				if($_SESSION[$final['pg_tag']]['s_proj_projtype']!='') $ip_data['con_projtype']=$_SESSION[$final['pg_tag']]['s_proj_projtype'];
				...
				if($_SESSION[$final['pg_tag']]['s_proj_keyword']!=''): //
					 ...
					 //客戶名稱／負責人／專案業務／履地點／備註１／２／３／工程編號／標地
				endif;

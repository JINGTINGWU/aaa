...
<div id="result_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/self_work/work_record_div',array('main_list'=>$main_list,'pd'=>$pd)); ?>
</div>
<div id="file_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/self_work/task_file_list_div',array('file_list'=>$file_list,'fpd'=>$fpd)); ?>
</div>
        </td>
    </tr>
</table>

...
<div id="result_area_div" class="mm_area_div_2" onclick="PL_DivClick();">
	...
	<table class="detail-div" cellspacing="1" cellpadding="3">
        ...
        <tr>
            ...
            <td><input type="button" value="上傳" onclick="thick_box('open','檔案上傳','<?=site_url('ecp_common/file_upload_div/project_list/'.$value['jec_project_id'].'/')?>')" class="mm_submit_button" <?=$this->ECPM->m_right_tag['up_da']?> /></td>
        </tr>        
        <?php endforeach;?>
    </table>
</div>

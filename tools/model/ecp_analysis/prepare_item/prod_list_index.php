...
//$pd_pp=10;
        ...
        switch($df_ip['ac']):
			...
			case 'update_projprod':
				...
				$gv=array("projprod_id","description",'price','startdate','quantity','jec_vendor_id','no','extramultiple','extraaddition','estimcostcalc','salecostcalc','prod_uom_id','prodspec','prodname'); $gv=$this->CM->GPV($gv);
				$no=$gv['no'];
				$projp_set=$this->CM->Init_TB_Set('mm_projprod_set');
				$upd=$gv;

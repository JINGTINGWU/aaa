...
//						$ip_data['con_'.$mm_tb.'proj_jec_user_id']=$temp1_id;
				...
				else:
				{
					...
					else
					{
						...
						if ($user_wi!='' && $group_wi!='')
							array_push($ip_data['orwhere'],"jec_user_id IN (".$user_wi.") OR ((proj_jec_user_id IN (".$user_wi.") OR proj_jec_usersales_id IN (".$user_wi."))) OR jec_group_id IN (".$group_wi.")");
						elseif ($user_wi!='' && $group_wi=='')
							array_push($ip_data['orwhere'],"jec_user_id IN (".$user_wi.") OR ((proj_jec_user_id IN (".$user_wi.") OR proj_jec_usersales_id IN (".$user_wi.")))");
						else
							array_push($ip_data['orwhere'],"jec_group_id IN (".$group_wi.")");
					}
				}
				endif;

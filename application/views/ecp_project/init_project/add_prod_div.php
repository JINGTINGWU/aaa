...
?>
	<table class="query-div" cellspacing="1" cellpadding="3" >
		...
		<tr>
        	<td align="right" width="100">*品名/工作明細：</td><td id="frominputarea" colspan="3"><input type="checkbox" id="prodsearch_type" onclick="PG_BK_Action('prod_search_type','prodsearch_type')" />只查我的部門<?=$main_op['jec_product_id_title']['op']?><?=$main_op['jec_product_id']['op']?><br /><label id="jec_product_id_title_lb"></label></td>

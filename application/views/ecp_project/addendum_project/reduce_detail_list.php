...
<table width="100%" onclick="PL_DivClick();">
	<tr>
        ...
        <div id="project_reduce_info_div" class="mm_area_div_3">
        	<?php $this->load->view($this->m_controller.'/addendum_project/project_reduce_info_div',array('proj_data'=>$proj_data)); ?>
        </div>
        </td>
        <td valign="top">
<div id="reduce_prod_div" class="mm_area_div_1" onclick="PL_DivClick();">
	<?php $this->load->view($this->m_controller.'/addendum_project/reduce_prod_div',array('main_op'=>$main_op,'form_url'=>$form_url)); ?>
</div>
<div id="result_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/addendum_project/r_prod_list_div',array('main_list'=>$main_list,'pd'=>$pd)); ?>

</div>
<div id="file_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/addendum_project/r_file_list_div',array('file_list'=>$file_list,'fpd'=>$fpd)); ?>
...
function PG_BK_Action(type,data)
{
	switch(type){
		...
		case 'after_del_prod':
			...
			break;			
		case 'reset_add_prod':
				ECP_Load_Div('reduce_prod_div','<?=$add_prod_url?>','');
			break;

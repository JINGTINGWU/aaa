...
//$pd_pp=10;
        ...
        switch($df_ip['ac']):
            case 'list': 
				...
				$final['prod_list_url']=site_url($final['var_purl'].'prod_list_index/list_div/'.$df_ip['key_id'].'/created/asc/0/N/');
				$final['update_projprod_url']=site_url($final['var_purl'].'prod_list_index/update_projprod/'.$df_ip['key_id'].'/');
				$final['check_prodtype_url']=base_url($final['var_purl'].'prod_list_index/check_prodtype/'.$df_ip['key_id'].'/');
				$final['import_producttemp_url']=site_url($final['var_purl'].'prod_list_index/import_producttemp/'.$df_ip['key_id'].'/');
				...
				$final['import_url']=base_url($final['var_purl'].$df_ip['tag'].'/import_ac/'.$df_ip['key_id'].'/');
				...
				$final['refresh_prepare_url'] = base_url($final['var_purl'].$df_ip['tag'].'/refresh_prepare_status/'.$final['projt_data']['jec_project_id'].'/');
				...
				$final['assign_view']='prod_list_index';
				$final['show_tcate']='Y';
				$final['show_plate']='Y'; 
				...
				$final['tcate_url']=array(
						'project_list_index'=>base_url($final['var_purl'].'project_list_index/list/'.$final['projt_data']['jec_project_id'].'/created/asc/0/N/'),
						'job_list_index'=>base_url($final['var_purl'].'job_list_index/list/'.$final['projt_data']['jec_project_id'].'/created/asc/0/N/'),
						...
						'task_list_index'=>base_url($final['var_purl'].'task_list_index/list/'.$final['projt_data']['jec_projjob_id'].'/created/asc/0/N/'),
						'record_list_index'=>base_url($final['var_purl'].'record_list_index/list/'.$df_ip['key_id'].'/created/asc/0/-1/'),
						'bk_url'=>base_url($final['var_purl'].'task_list_index/list/'.$final['projt_data']['jec_projjob_id'].'/created/asc/0/N/')
					);/**/
			...
			case 'add_projprod':
				...
				$gv=array("jec_product_id","description",'jec_vendor_id','vendor_name','startdate','quantity','price','prod_uom_id','prodspec','prodname','extramultiple','extraaddition','prodtype'); $gv=$this->CM->GPV($gv);
				$upd=array_merge($gv,$this->CM->Base_New_UPD());//
				if($upd['jec_vendor_id']==0) $upd['jec_vendor_id']=null; //假如id=0, 設成null
			...
			case 'update_projprod':
				...
				$gv=array("projprod_id",'price','startdate','quantity','vendor_name','no','extramultiple','extraaddition','estimcostcalc','totalsubtract','salecostcalc','prod_uom_id','prodspec','prodname','description'); $gv=$this->CM->GPV($gv);//,"description"
				$no=$gv['no'];
				$projp_set=$this->CM->Init_TB_Set('mm_projprod_set');
				$upd=$gv;

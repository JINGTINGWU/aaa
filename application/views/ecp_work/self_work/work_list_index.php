...
<div id="result_area_div" class="mm_area_div_2"  onclick="PL_DivClick();">
	...
	<table class="detail-div" cellspacing="1" cellpadding="3">
    	<tr>
    		<td colspan="15">工作項目列表 (說明: 明細按鈕呈現黃色者, 表示已有明細在內)</td>
    	</tr>
        <tr>
        ...
        <tr> 
          ...
          <td style="width:150px;word-break: break-all;"><a href='<?=$this->config->item('base_url')?>ecp_project/adjust_project_mng/job_list_index/list/<?=$value['jec_project_id']?>/created/asc/0/-1'><?=$value['job_name']?></a></td> 

...
<table width="100%">
    ...
    <tr>
    	<td valign="top">
			...
			<!-- <iframe width="100%" style="height:500px;border:#999999 1px solid;" src="<?=$list_url?>" scrolling="yes" frameborder="0"></iframe>--> <?php $this->load->view($this->m_controller.'/adjust_project/deletetask_list_div',array('proj_data'=>$proj_data)); ?>
	...
	case 'delete_task':
		if(PG_BK_Action('check_select',{})==true){
			if(confirm("確定批次刪除工作?")){
				...
				document.getElementById('edit_form').action = "<?=$delete_date_url?>";

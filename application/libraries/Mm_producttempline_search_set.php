...
class Mm_producttempline_search_set
{
    var $mm_tb='jec_producttempline_search_view';
	var $mm_tablename='JEC_Producttempline_search_view';
	var $mm_glt='2';
    var $mm_td=array();
    var $mm_kid='jec_producttempline_id';
    var $mm_deltype='isactive';
    var $mm_actb='jec_producttempline';

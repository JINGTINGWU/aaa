        	<table class="info-div" cellspacing="1" cellpadding="3">
                ...
                <tr>
                	<td colspan="2"><input type="button" value="查看工作紀錄"  onclick="JS_Link('<?=site_url($var_purl.'work_record_index/list/'.$projt_data['jec_projnotice_id'].'/')?>');" class="mm_submit_button"  ></td>
                </tr>
            </table>

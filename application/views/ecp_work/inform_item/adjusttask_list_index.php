...
<table width="100%">
    ...
    <tr>
    	<td valign="top">
			...
			<!-- <iframe width="100%" style="height:500px;border:#999999 1px solid;" src="<?=$list_url?>" scrolling="yes" frameborder="0"></iframe>--> <?php $this->load->view($this->m_controller.'/inform_item/adjusttask_list_div',array('proj_data'=>$proj_data)); ?>
...
{	var info=Array();
	...
	switch(type){
	case 'adjust_date':		
			if(confirm("確定同意勾選的工作展期並退回未勾選的工作展期要求?")){

...
?><tr><td onclick="PL_SelectList('<?=$no?>')" id="search_value_<?=$no?>" class="off_select" onmouseover="this.className='on_select'" onmouseout="this.className='off_select'" abbr="<?=$value['jec_product_id']?>" ><?=$value['value']?></td></tr><?php
endforeach;
?>
</table>

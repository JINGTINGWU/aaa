...
<table width="100%" onclick="PL_DivClick();">
	<tr>
        ...
        <td valign="top">
<div id="add_job_div" class="mm_area_div_1" onclick="PL_DivClick();">
	<?php $this->load->view($this->m_controller.'/adjust_project/add_job_div',array('main_op'=>$main_op,'form_url'=>$form_url,'proj_data'=>$proj_data)); ?>
</div>
<div id="result_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/adjust_project/job_list_div',array('main_list'=>$main_list,'pd'=>$pd,'proj_data'=>$proj_data)); ?>
</div>
<div id="file_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/adjust_project/project_file_list_div',array('file_list'=>$file_list,'fpd'=>$fpd,'proj_data'=>$proj_data)); ?>
</div>
        </td>
    </tr>
</table>

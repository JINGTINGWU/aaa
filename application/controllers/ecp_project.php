...
class Ecp_project extends CI_Controller 
{
    var $mm_base_url='';
    var $m_controller='ecp_project';
    var $m_pp=30; //統一的每頁筆數  
    var $var_to_array='common/var_to_array.php';
    var $def_info=array(
            'MDST'=>'ECPM'
        );
    var $df_array=array('tag','ac','np','key_id','ob','ot','pp','seg','s_cate','MDST','chinfo','task_id');    
    ...
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='create_project';
    ...
    function create_project_mng($tag='project_list_index',$ac='list',$key_id=0,$ob='created',$ot='DESC',$np=0,$chinfo='')
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='create_project';
        if(isset($_POST['kid'])) $key_id=$_POST['kid'];
        $this->load->model('Mmm_'.$s_cate.'_model',$MDST,True);
        $df_array=$this->df_array;
    ...
    function init_project_mng($tag='project_list_index',$ac='list',$key_id=0,$ob='created',$ot='DESC',$np=0,$chinfo='')
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='init_project';
        if(isset($_POST['kid'])) $key_id=$_POST['kid'];
        $this->load->model('Mmm_'.$s_cate.'_model',$MDST,True);
        $df_array=$this->df_array;
        include ('tools/'.$this->var_to_array);
    ...
    function adjust_project_mng($tag='project_list_index',$ac='list',$key_id=0,$ob='created',$ot='DESC',$np=0,$chinfo='',$task_id=0)
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='adjust_project';
        if(isset($_POST['kid'])) $key_id=$_POST['kid'];
        $this->load->model('Mmm_'.$s_cate.'_model',$MDST,True);
        $df_array=$this->df_array;
        include ('tools/'.$this->var_to_array);
    ...
    function addendum_project_mng($tag='project_list_index',$ac='list',$key_id=0,$ob='created',$ot='DESC',$np=0,$chinfo='')
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='addendum_project';
        if(isset($_POST['kid'])) $key_id=$_POST['kid'];
        $this->load->model('Mmm_'.$s_cate.'_model',$MDST,True);
        $df_array=$this->df_array;
        include ('tools/'.$this->var_to_array);		
    ...
    function cost_project_mng($tag='project_list_index',$ac='list',$key_id=0,$ob='created',$ot='DESC',$np=0,$chinfo='')
    {   global $_G; $MDST=$this->def_info['MDST']; $pp=$this->m_pp; $seg=7; $s_cate='cost_project';
        if(isset($_POST['kid'])) $key_id=$_POST['kid'];
        $this->load->model('Mmm_'.$s_cate.'_model',$MDST,True);
        $df_array=$this->df_array;
        include ('tools/'.$this->var_to_array);

        ...
        switch($df_ip['ac']):
			...
			*/
				...
				*/
				...
				$final['refresh_url']=base_url($final['var_purl'].'calendar_list_index/list/0/created/DESC/0/N/');
				
				
				$final['assign_view']='new_calendar_index';
				$final['show_tcate']='Y';
				$final['show_plate']='Y';
				//$pd_pp=10;	
				$pd_pp=$df_ip['pp'];
				...
				*/
				...
				$final['tcate_url']=array(
						'calendar_list_index'=>site_url($final['var_purl'].'calendar_list_index/list/')
					);
            break;
			case 'add_self_cal':

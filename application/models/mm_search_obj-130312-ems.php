...
{   //查詢項目設定// 
	...
	{	//
		$info=array(
				'def_proj'=>array('s_proj_value','s_proj_jec_company_id','s_proj_jec_customer_id','s_proj_name','s_proj_projstatus','s_proj_keyword','s_proj_date','s_proj_customer_title','s_proj_jec_salesuser_id','s_proj_salesuser_title','excel_type'),
				...
				'def_ana_work'=>array('s_proj_name','s_proj_jec_customer_id','s_proj_customer_title','s_task_taskprogress','s_task_name','s_task_tasktype','s_dept_id','s_user_id','s_user_id_title','excel_type'),

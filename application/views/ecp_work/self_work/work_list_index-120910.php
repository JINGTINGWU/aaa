...
<div id="result_area_div" class="mm_area_div_2"  onclick="PL_DivClick();">
	...
	<table  class="detail-div" cellspacing="1" cellpadding="3">
        ...
        <tr>
            ...
            <td class="mm_table2_title2"  id="detail-normal">工作明細</td>
            <td class="mm_table2_title2"  id="detail-normal">工作回報</td>  
        ...
        <tr> 
            ...
            <td><input type="button" value="工作明細" onclick="JS_Link('<?=site_url($var_purl.'work_detail_index/list/'.$value['jec_projtask_id'].'/')?>');" class="mm_submit_button"  ></td>
            <td><?php if(in_array($value['projtasktype'],$btn_allow)&&($value['replystatus']==0||$value['replystatus']==5)):?><input type="button" value="工作回報" onclick="JS_Link('<?=site_url($var_purl.'work_report_index/list/'.$value['jec_projtask_id'].'/')?>');" class="mm_submit_button"  ><?php endif;?></td></td>  

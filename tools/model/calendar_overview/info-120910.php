<?php
        switch($df_ip['ac']):
            case 'list': 
				...
				$cal_list=$this->GM->common_ac('list',array('info'=>$cal_v_set['mm_set'],'type'=>'def','data'=>array('con_jec_user_id'=>$this->ad_id,'wi'=>array('noticefrom'=>array(1,2)),'con_startdate <='=>$search_sed['ed'].' 99:99:99','con_enddate >='=>$search_sed['sd'].' 00:00:00')));

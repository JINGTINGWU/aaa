...
<div id="search_area_div"  class="mm_area_div_1">
    ...
    <div id="add_prod_div">
		...
		<?php $this->load->view($this->m_controller.'/init_project/add_prod_div',array('main_op'=>$main_op,'form_url'=>$form_url,'proj_data'=>$proj_data)); ?>
...
<div id="result_area_div"  class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/init_project/prod_list_div',array('main_list'=>$main_list,'uom_pdb'=>$uom_pdb,'pd'=>$pd,'proj_data'=>$proj_data)); ?>
</div> 
</td></tr>

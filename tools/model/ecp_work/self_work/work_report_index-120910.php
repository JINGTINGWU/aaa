...
$this->load->model('Mm_encode_model', 'MEM');
        switch($df_ip['ac']):
			...
			case 'rp_finish'://
				$gv=array("time_tag",'rp_time','content'); $gv=$this->CM->GPV($gv);
			...
			case 'rp_adjust':
				...
				$gv=array("time_tag",'rp_time','content','rp_adtime_enddate','rp_adtime_startdate'); $gv=$this->CM->GPV($gv);
				$cal_set=$this->CM->Init_TB_Set('mm_calendar_set');
				$projt_set=$this->CM->Init_TB_Set('mm_projtask_set');
				$projt_v_set=$this->CM->Init_TB_Set('mm_projtask_search_set');
				$projt_data=$this->$projt_v_set['mm_set']->get_projtask_row($df_ip['key_id']);
				...
				//adjust_projtask
				$this->GM->common_ac('update',array('info'=>$projt_set['mm_set'],'upt'=>'def','kid'=>$df_ip['key_id'],'upd'=>array('projtasktype'=>2,'replystatus'=>2,'isconfirm'=>'N','noticetime'=>date('Y-m-d H:i:s'),'jec_projnotice_id'=>$t_projnotice_id)));
			...
			case 'rp_transfer':
				$gv=array("time_tag",'rp_time','content','jec_usernew_id'); $gv=$this->CM->GPV($gv);
				...
				$this->db->where($projn_set['mm_kid'],$t_projnotice_id)->update($projn_set['mm_tb'],array('jec_calendar_id'=>$t_calendar_id));
				//adjust_projtask
				$this->GM->common_ac('update',array('info'=>$projt_set['mm_set'],'upt'=>'def','kid'=>$df_ip['key_id'],'upd'=>array('projtasktype'=>3,'replystatus'=>3,'isconfirm'=>'N','noticetime'=>date('Y-m-d H:i:s'),'jec_projnotice_id'=>$t_projnotice_id)));
			...
			case 'rp_pause':
				...
				$this->db->where($projn_set['mm_kid'],$t_projnotice_id)->update($projn_set['mm_tb'],array('jec_calendar_id'=>$t_calendar_id));
				//adjust_projtask
				$this->GM->common_ac('update',array('info'=>$projt_set['mm_set'],'upt'=>'def','kid'=>$df_ip['key_id'],'upd'=>array('projtasktype'=>5,'replystatus'=>5,'isconfirm'=>'N','noticetime'=>date('Y-m-d H:i:s'),'jec_projnotice_id'=>$t_projnotice_id)));
			...
			case 'rp_recover':
				...
				//adjust_projtask
				$this->GM->common_ac('update',array('info'=>$projt_set['mm_set'],'upt'=>'def','kid'=>$df_ip['key_id'],'upd'=>array('projtasktype'=>2,'replystatus'=>6,'isconfirm'=>'N','noticetime'=>date('Y-m-d H:i:s'),'jec_projnotice_id'=>$t_projnotice_id)));

...
class Mm_projecttempjob_set
{
    var $mm_tb='jec_projecttempjob';
	var $mm_tablename='JEC_Projecttempjob';
	var $mm_glt='2';
    var $mm_td=array();
    var $mm_kid='jec_projecttempjob_id';
    var $mm_deltype='isactive';
    var $mm_actb='jec_projecttempjob';
	...
	{   global $_G;
	    $this->mm_td=array(
				...
				'join_job'=>array(
						'join'=>array('type'=>'left','jtb'=>'jec_job','jkey'=>'jec_job_id','mkey'=>'jec_job_id','tb'=>$this->mm_tb),

			...
			*/
			...
			case 'send_prepare_easyflow'://
			    ...
			    $objPHPExcel->setActiveSheetIndex(0)
							...
							->mergeCells('E2:I2')
							->setCellValue('E2', '工程編號：'.$data['proj_data']['value2']);							
				...
				$eno++;
						 $objPHPExcel->setActiveSheetIndex(0)
            			 //->setCellValue('A'.$eno, $value['value'])
						 ->mergeCells('A'.$eno.':B'.$eno)
           				 ->setCellValue('A'.$eno, "預估成本總計")
						 ->setCellValue('C'.$eno, '')
						 ->setCellValue('D'.$eno, '')
						 ->setCellValue('E'.$eno, '')
						 ->setCellValue('F'.$eno, $final_total)
						 ->setCellValue('G'.$eno, '')
						 ->setCellValue('H'.$eno, '')
						 ->setCellValue('I'.$eno, '')
						 ;					
...
// Redirect output to a client’s web browser (Excel5)
				...
				$AD004_upd=array(
						'ad004001'=>'',
						'ad004002'=>'',
						'ad004003'=>'年月日+流水號',//flow-取流水號
						'ad004004'=>$this->CM->pdb_trans('無'),//...
						'ad004005'=>'',//vendor_no
						'ad004006'=>$this->CM->pdb_trans($p_user['value']),//p_acc 承辦人->登入者
						'ad004007'=>$this->CM->pdb_trans($p_user['name']),//p_name
						'ad004008'=>$ms_p_user['deptname'],//p_dept 
						'ad004009'=>'',//$gv['ad005009']-需用日期
						'ad004010'=>'',
						'ad004011'=>'',
						'ad004012'=>'',//apply_dept
						'ad004013'=>'',
						...
						//'ad004015'=>'',//rece_dept
						'ad004016'=>'', //附註用途
						'ad004017'=>'',//採購金額國字 $gv['ad005017']
						'ad004018'=>'',//採購金額-數字  $gv['ad005018']
						'ad004019'=>'',//審核知會
						'ad004020'=>'',//領用人員
						'ad004021'=>'',
						'ad004022'=>'',
						...
						'ad004024'=>'',
						'ad004025'=>'',
						'ad004026'=>$this->CM->pdb_trans('履約管制系統'),
						'ad004027'=>$this->$prodprep_v_set['mm_set']->get_projfile_string($data['proj_data']),//附件字串
						'ad004099'=>'',
						'ad004900'=>'',
						'ad004901'=>'',
						'ad004902'=>'',
						...
						'ad004904'=>'',		
						'ad004905'=>'',	
						'ad004910'=>$serial//code												
					);
				
					$e_upd=array(
							'strFormID'=>$this->CM->pdb_trans('AD004'),
							...
							'FieldValue'=>$this->CM->pdb_trans('PMS-'.$data['proj_data']['name'].'-履約備品清單') //$現在日期$-$專案名稱$-$任務名稱$-$工作明稱$
						);
						
					$mssqlef->insert('ressa',$e_upd);//
												
				foreach($AD004_upd as $st=>$sv):
					$e_upd=array(
							'strFormID'=>$this->CM->pdb_trans('AD004'),
							'ScriptSheetNo'=>$this->CM->pdb_trans($time),
							'Owner'=>$this->CM->pdb_trans($p_user['value']),//acc
							'RecordsetName'=>$this->CM->pdb_trans('rstAD004'),

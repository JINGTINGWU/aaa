...
<div id="result_area_div"  class="mm_area_div_2">
	...
	<table class="detail-div" cellspacing="1" cellpadding="3">
    	<tr>
    		<td colspan="9" class="mm_table2_title">專案資料列表</td>
    	</tr>
        <tr>
            ...
            <td class="mm_table2_title2" id="detail-normal">批次確認</td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="button" value="<?=$allprojdesc[$value['jec_project_id']]?>確認" onclick="JS_Link('<?=$allprojdesc[$value['jec_project_id']]=='批次展期'?site_url($var_purl.'adjusttask_list_index/list/'.$value['jec_project_id'].'/'):site_url($var_purl.'deletetask_list_index/list/'.$value['jec_project_id'].'/')?>');"  /></td>
        </tr>        
        <?php endforeach;?>
    </table>
</div>

...
<div id="result_area_div" class="mm_area_div_2" onclick="PL_DivClick();">
	...
	<table class="detail-div" cellspacing="1" cellpadding="3">
    	<tr>
    		<td colspan="11" class="mm_table2_title">履約備品清單列表</td>
    	</tr>
        <tr>
        ...
        <tr id="tr_<?=$no?>">
            ...
            <td><input type="button" value="備品清單" onclick="JS_Link('<?=site_url($var_purl.'item_detail_index/list/'.$value['jec_project_id'].'/seqno/ASC/0/')?>');" class="mm_submit_button" <?=$value['isproductprep']=='Y'?'':'disabled'?>  /></td>

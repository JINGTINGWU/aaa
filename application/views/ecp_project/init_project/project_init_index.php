...
<div id="result_area_div" class="mm_area_div_2">
	<table class="detail-div" cellspacing="1" cellpadding="3">
        ...
        <tr>
        	<td class="mm_table2_title2"  id="detail-normal">項次</td>
            <td class="mm_table2_title2"  id="detail-normal">任務名稱</td>
            <td class="mm_table2_title2"  id="detail-normal">工作項目</td>
            <td class="mm_table2_title2"  id="detail-normal">負責人員</td>  
            <td class="mm_table2_title2"  id="detail-normal">工作日期</td>   
            <td class="mm_table2_title2"  id="detail-normal">料品與工作明細</td> 
            <td class="mm_table2_title2"  id="detail-normal">數量*單價=金額</td> 

...
{   //查詢項目設定// 
	...
	{	global $_G;
        $final=array(
				...
				's_proj_projtype'=>array(
                        'call_name'=>'專案性質',
                        'type'=>'select',
						'ld'=>$this->$_G['L_CS']->common_use_ld('projtype'),
						'ld_key'=>'id',
						'ld_value'=>'name'
                    ),
	...
	{	//
		$info=array(
				'def_proj'=>array('s_proj_value','s_proj_jec_company_id','s_proj_jec_customer_id','s_proj_name','s_proj_projtype','s_proj_projstatus','s_proj_keyword','s_proj_value2','s_proj_date','s_proj_customer_title','s_proj_jec_salesuser_id','s_proj_salesuser_title','s_dept_id','s_projdept_id','excel_type'),
				//工作列表搜尋加入任務名稱
				'def_task'=>array('s_proj_value','s_proj_name','s_job_name','s_task_keyword','s_task_name','s_task_tasktype','s_task_taskprogress','s_task_startdate','s_task_enddate','s_task_proj_user_id_title','s_task_proj_user_id'),
				//通知列表搜尋加入任務名稱
				'def_inform'=>array('s_noticetype','s_proj_value','s_proj_name','s_job_name','s_keyword','s_task_name','s_startdate','s_enddate','s_string'),
				...
				//工作狀態查詢搜尋加入任務名稱
				'def_ana_work'=>array('s_proj_projtype','s_proj_name','s_job_name','s_proj_jec_customer_id','s_proj_customer_title','s_task_taskprogress','s_task_name','s_task_tasktype','s_dept_id','s_projdept_id','s_user_id','s_user_id_title','s_superuser_id','s_superuser_id_title','excel_type','s_proj_projstatus','s_startdate','s_enddate','s_startdate2','s_enddate2'),

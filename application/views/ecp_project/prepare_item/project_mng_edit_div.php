        	<table  class="info-div" cellspacing="1" cellpadding="3">
                ...
                <tr>
                	<td colspan="2"><input type="button" value="確認專案得標/專案開展" onclick="AWEA_Ajax('<?=base_url($var_purl.$tag.'/init_project/'.$proj_data['jec_project_id'].'/')?>')" class="mm_submit_button" <?=$this->ECPM->m_right_tag['up_da']?> /></td>
                </tr>         
            </table>

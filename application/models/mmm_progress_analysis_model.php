...
class Mmm_progress_analysis_model extends CI_Model 
{   //進度分析
    var $m_base_scate='progress_analysis';//*
    var $m_function='progress_analysis_mng';
	var $m_lib_folder='tools/model/cost_progress/';
    var $m_index='project_list_index';
	var $m_menu_id=MM_menu_progress_analysis;

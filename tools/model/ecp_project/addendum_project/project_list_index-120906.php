        ...
        switch($df_ip['ac']):
            case 'list': 
				...
				if($_SESSION[$final['pg_tag']]['s_proj_keyword']!=''): //
					 array_push($ip_data['orwhere'],"".$mm_tb.".value LIKE '%".$_SESSION[$final['pg_tag']]['s_proj_keyword']."%' OR name ".$mm_tb.".LIKE '%".$_SESSION[$final['pg_tag']]['s_proj_keyword']."%'");
				endif;
				...
				$final['pd']=$this->GM->page_data(array('now_ot'=>$df_ip['ot'],'uri_segment'=>$df_ip['seg'],'base_url'=>base_url().$this->m_controller.'/'.$this->m_function.'/'.$df_ip['tag'].'/'.$df_ip['ac'].'/'.$df_ip['key_id'].'/'.$df_ip['ob'].'/'.$df_ip['ot'].'-'.$pd_pp.'/','mm_spec_url'=>array('ot_desc_url'=>'DESC@@@'.$df_ip['ot'],'ot_asc_url'=>'ASC@@@'.$df_ip['ot'],'ob_value_url'=>'value@@@'.$df_ip['ob'],'ob_jec_company_id_url'=>'jec_company_id@@@'.$df_ip['ob'],'ob_jec_usersales_id_url'=>'jec_usersales_id@@@'.$df_ip['ob'],'ob_projstatus_url'=>'projstatus@@@'.$df_ip['ob'],'ob_name_url'=>'name@@@'.$df_ip['ob'],'ob_customer_name_url'=>'customer_name@@@'.$df_ip['ob'],'ob_startdate_url'=>'startdate@@@'.$df_ip['ob'],'ob_projtype_url'=>'projtype@@@'.$df_ip['ob'],'ob_as_estimated_cost_url'=>'as_estimated_cost@@@'.$df_ip['ob'],'ob_add_estimated_cost_url'=>'add_estimated_cost@@@'.$df_ip['ob'],'ob_sub_estimated_cost_url'=>'sub_estimated_cost@@@'.$df_ip['ob'])));

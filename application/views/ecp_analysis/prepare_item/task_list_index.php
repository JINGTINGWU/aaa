...
<div id="add_task_div"  class="mm_area_div_1" onclick="PL_DivClick();">
	<?php $this->load->view($this->m_controller.'/init_project/add_task_div',array('main_op'=>$main_op,'form_url'=>$form_url)); ?>
</div>
<div id="result_area_div"  class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/init_project/task_list_div',array('main_list'=>$main_list,'pd'=>$pd,'user_ld'=>$ip_info['jec_user_id']['ld'])); ?>
</div>
<div id="file_area_div" class="mm_area_div_2">
	<?php $this->load->view($this->m_controller.'/init_project/job_file_list_div',array('main_list'=>$file_list,'fpd'=>$fpd)); ?>
</div>
        </td>
    </tr>
</table>
